  ...
  return (
    ...
    <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 gap-10'>
      ...
      <div className=' flex flex-col justify-center ml-14'>
            <h1 className='text-white font-bold text-3xl md:text-5xl py-6 '>Kick start your tech <br /> career with us</h1>
            <p className='text-white'> Get ready to lunch into the tech universe with us! Discover <br />
         an exhilarating opportunity to kickstart your journey in tech. <br /> our
         beginner-friendly learning platform is lunchpad, and we <br />are ecstatic to
         have you on board for an incredible adventure</p>
         
            <button className=" bg-orange-400 mt-20 w-40 text-white border-radius-5 rounded" onClick={() => console.log("connect")}>
              start leanring
