...
import style from '../components/style/Form.module.css'
import land from '../components/assets/form.png'
  ...
  return (
    ...
    <div className='container-fluid' id={style.body}>
        <div className=' container mx-auto row' id={style.zentrix}>
            <div className='col-md-4 offset-1 mt-20 text-black' >
            ...
            <div className='col-md-4 offset-1'>
                <img src={land} alt="land" className='w-115 h-75 mt-20'/>    
            </div>
        </div>
